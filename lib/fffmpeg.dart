...
class Fffmpeg {
  ...
  static Future<dynamic> addWatermarkToVideo(String inputPath,String outputPath,String watermarkPath,WaterMarkPosition waterMarkPosition)async{
  ...
  static List<String> getCommand(String inputPath,String outputPath,String imagesPath,WaterMarkPosition waterMarkPosition){
    List<String> commands=List.filled(26, "");
    if(waterMarkPosition==WaterMarkPosition.LeftTop){
