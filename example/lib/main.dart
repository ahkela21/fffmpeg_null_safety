      ...
      home: Scaffold(
        floatingActionButton: FloatingActionButton(
          onPressed: ()async{
            ...
            Fffmpeg.addWatermarkToVideo(input, output, logo, WaterMarkPosition.LeftBottom);
...
//       await File(outputPath).create();
      ...
      //处理完返回路径吧
    return  await Fffmpeg.addWatermarkToVideo(input,output,logo,WaterMarkPosition.LeftBottom);
